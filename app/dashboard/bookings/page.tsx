  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">My Bookings</h1>
        <p className="text-gray-500 dark:text-gray-400 mb-8">All your service bookings in one place</p>
        {bookings.length === 0 ? (
          ...
          <div className="flex flex-col gap-4">
            {bookings.map((booking) => (
              <div key={booking.id} className="bg-white dark:bg-slate-800 rounded-xl border border-gray-100 dark:border-slate-700 p-6 flex items-center justify-between">
                <div>
                  <h2 className="text-lg font-semibold text-gray-800 dark:text-white">{booking.service.title}</h2>
