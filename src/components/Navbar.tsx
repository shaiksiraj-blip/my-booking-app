              ...
              {[
                {
                  icon: '📅',
                  title: 'Easy Booking',
                  desc: 'Book any service in just a few clicks. Pick your time slot and confirm instantly.',
                },
                {
                  icon: '💳',
                  title: 'Secure Payments',
                  desc: 'Pay safely with UPI, cards, or net banking powered by Razorpay.',
                },
                {
                  icon: '✅',
                  title: 'Instant Confirmation',
                  desc: 'Get email confirmation immediately after booking. No waiting.',
                },
              ].map((feature) => (
        ...
        <section className="bg-indigo-50 py-20 px-4">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-gray-500 mb-8">
              Browse our services and book your first appointment today.
            </p>
            <Link
              href="/services"
